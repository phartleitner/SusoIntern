...
$.post("", {
				'type': 'checkprevabs',
				'console': '',
				'id': searchList.find(result => result.id == activeElement )['id'],
...
anzeige = activeDataSet['adminMeldung'] +"<b> (" + formatDateDot(activeDataSet['adminMeldungDatum'])+')</b><br/>';	
}
if (activeDataSet['beurlaubt'] == 0) {
	if (activeDataSet['lehrerMeldung'] != "0") {
	anzeige += activeDataSet['lehrerMeldung'] + " (<b>" + formatDateDot(activeDataSet['lehrerMeldungDatum'])+')</b><br/>';	
	}
	if (activeDataSet['elternMeldung'] != "0") {
	anzeige += "Eintrag Eltern<b> (" + formatDateDot(activeDataSet['elternMeldungDatum'])+')</b>';	
	}
	if (activeDataSet['entschuldigt'] != "0000-00-00") {
	anzeige += "<br>Entschuldigung am: <b>" + formatDateDot(activeDataSet['entschuldigt'])+'</b>';	
	}	
}
if (activeDataSet['kommentar'] != "") {
anzeige += "<br>Kommentar: " + activeDataSet['kommentar'];	
}
content += '<br/>' + anzeige;
